locals {
  ...
  # apply. NOT the same credential as signals' RAYA_VOICE_BOT_API_KEY (inbound,
  # generated by random_passwords) nor secrets.voiceDpgSignalsSecret (that bot's
  # Keycloak client secret) — three values, one vendor, independently rotatable.
  raya_api_key             = try(local.manual_secrets.raya_api_key, "UPDATE_THIS_VALUE")
