locals {
  ...
  signals_auth_secret_bytes                     = try(local.global_vars.global.signals_auth_secret_bytes, 16)
  signals_notification_secret_bytes             = try(local.global_vars.global.signals_notification_secret_bytes, 16)
  signals_dpg_scoring_secret_bytes              = try(local.global_vars.global.signals_dpg_scoring_secret_bytes, 32)
  aggregator_postgres_password_bytes            = try(local.global_vars.global.aggregator_postgres_password_bytes, 32)
  aggregator_kc_bootstrap_admin_password_bytes  = try(local.global_vars.global.aggregator_kc_bootstrap_admin_password_bytes, 32)
