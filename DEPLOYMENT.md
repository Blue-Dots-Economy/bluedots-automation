...
## 4. Deploy the services — step by step
...
## 5. Deploy everything at once (alternative to step 4)
...
Use the step-by-step flow (step 4) when you want to inspect health between
